...
const CONFIG = {
    ...
    MAGIC: {
        WIND:      { name: 'Ветер',        pushDistance: 80, targets: 6,  manaCost: 30, cooldown: 7000,  color: 0x88ccff, icon: '💨', hotkey: 'Q', gemCost: 0 },
        FREEZE:    { name: 'Заморозка',    duration: 3500,               manaCost: 45, cooldown: 15000,  color: 0x00ffff, icon: '❄️', hotkey: 'W', gemCost: 4 },
