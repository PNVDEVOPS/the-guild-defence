...
const CONFIG = {
    ...
    MAGIC: {
        ...
        LIGHTNING: { name: 'Молния',       damage: 120, targets: 6,       manaCost: 55, cooldown: 60000, color: 0xffff00, icon: '⚡', hotkey: 'E', gemCost: 8 },
        HEAL:      { name: 'Исцеление',    healAmount: 50,                manaCost: 45, cooldown: 30000, color: 0x00ff00, icon: '💚', hotkey: 'R', gemCost: 5 },
