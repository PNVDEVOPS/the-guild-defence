...
const CONFIG = {
    ...
    WEAPONS: {
        ...
        BOOMERANG: {
            ...
            baseMaxRange: 400, boomerang: true,
            icon: '🪃', unlockWave: 15,
            upgrades: {
            ...
            ammoType: 'NORMAL',
            ammoCost: { ELECTRIC: 600, FIRE: 550, ICE: 500, MULTI: 700 }
        },
        PLASMA: {
        ...
        FLAME_TOWER: {
            ...
            ammoType: 'FIRE',
            ammoCost: { ELECTRIC: 1500, FIRE: 0, ICE: 1400, MULTI: 1600 }
        },
        LASER: {
        ...
        BALLISTA: {
            ...
            ammoType: 'NORMAL',
            ammoCost: { ELECTRIC: 3000, FIRE: 2800, ICE: 2600, MULTI: 3500 }
        }
    },
    ...
    ENEMIES: {
        ...
        GOLEM: {
            name: 'Голем', hp: 400, speed: 12, reward: 40, damage: 45,
            size: 75, color: 0x888866, moveType: 'straight', icon: '🪨',
            immuneToSlow: true, immuneToFreeze: true
        },
        GOLEM_ELITE: {
            name: 'Элитный Голем', hp: 800, speed: 16, reward: 80, damage: 70,
            size: 85, color: 0x666644, moveType: 'straight', icon: '🪨',
            isElite: true, projectileCount: 2, immuneToSlow: true, immuneToFreeze: true
        },
        NECROMANCER: {
        ...
        NECROMANCER_ELITE: {
            name: 'Элитный Некромант', hp: 150, speed: 22, reward: 75, damage: 10,
            size: 58, color: 0x5500aa, moveType: 'straight', icon: '🧙',
            isElite: true, projectileCount: 2,
            canResurrect: true, resurrectRate: 3500, resurrectRange: 250, resurrectCount: 2
        },
        ASSASSIN: {
        ...
        ASSASSIN_ELITE: {
            name: 'Элитный Ассасин', hp: 90, speed: 60, reward: 55, damage: 35,
            size: 52, color: 0x222255, moveType: 'assassin', icon: '🗡️',
            isElite: true, projectileCount: 2,
            stealthAtPercent: 0.7, revealAtPercent: 0.15, burstSpeedMult: 4
        },
        DRAGON_RIDER: {
        ...
        MEGA_GOLEM: {
            name: 'Мега Голем',
            hp: 3000, speed: 15, reward: 600, damage: 50,
            size: 140, color: 0x554422, moveType: 'straight',
            isBoss: true, immuneToSlow: true, immuneToFreeze: true,
            groundPound: true, groundPoundDamage: 25, groundPoundInterval: 6000, groundPoundRadius: 150,
            icon: '🏔️'
        }
    },
    ...
    WAVE_CONFIG: {
        ...
        unlockWaves: {
            GOBLIN: 1, ORC: 3, ZIGZAG: 4, SHOOTER: 6, TROLL: 8,
            SKELETON: 10, DASHER: 12, GOLEM: 14, HEALER: 15,
            NECROMANCER: 20, ASSASSIN: 22, DRAGON_RIDER: 28
        },
        spawnWeights: {
            GOBLIN: 10, ORC: 7, ZIGZAG: 6, SHOOTER: 5, TROLL: 3,
            SKELETON: 8, DASHER: 4, GOLEM: 2, HEALER: 2,
            NECROMANCER: 2, ASSASSIN: 3, DRAGON_RIDER: 1
        },
    ...
    // ==============================================
    // УРОВНИ (10 волн = 1 уровень)
    // ==============================================
    LEVELS: {
        1:  { name: 'Гоблинский Лес',   waves: 10, bossType: 'BOSS',      reward: { gems: 3, gold: 50 } },
        2:  { name: 'Тёмные Пещеры',    waves: 10, bossType: 'BOSS',      reward: { gems: 4, gold: 80 } },
        3:  { name: 'Болота Смерти',     waves: 10, bossType: 'MEGA_GOLEM', reward: { gems: 5, gold: 120 } },
        4:  { name: 'Некрополь',         waves: 10, bossType: 'BOSS',      reward: { gems: 6, gold: 150 } },
        5:  { name: 'Логово Дракона',    waves: 10, bossType: 'MEGA_BOSS', reward: { gems: 8, gold: 200 } },
        6:  { name: 'Ледяные Вершины',   waves: 10, bossType: 'BOSS',      reward: { gems: 7, gold: 180 } },
        7:  { name: 'Огненная Бездна',   waves: 10, bossType: 'MEGA_GOLEM', reward: { gems: 8, gold: 220 } },
        8:  { name: 'Земли Хаоса',       waves: 10, bossType: 'BOSS',      reward: { gems: 9, gold: 250 } },
        9:  { name: 'Тёмная Цитадель',   waves: 10, bossType: 'BOSS',      reward: { gems: 10, gold: 300 } },
        10: { name: 'Трон Тьмы',         waves: 10, bossType: 'MEGA_BOSS', reward: { gems: 15, gold: 500 } }
    },
    ...
    TALENTS: {
        ATTACK: {
            damage:   { name: '+Урон',       icon: '⚔️', maxLevel: 5, costPerLevel: [1,2,3,4,5], effectPerLevel: 0.05 },
            fireRate: { name: '+Скорость',   icon: '🏹', maxLevel: 5, costPerLevel: [1,2,3,4,5], effectPerLevel: 0.05 },
            crit:     { name: '+Крит',       icon: '💥', maxLevel: 5, costPerLevel: [2,3,4,5,6], effectPerLevel: 0.02 }
        },
        DEFENSE: {
            maxHp:  { name: '+HP Замка',   icon: '🏰', maxLevel: 5, costPerLevel: [1,2,3,4,5], effectPerLevel: 0.1 },
            regen:  { name: '+Реген',      icon: '💚', maxLevel: 5, costPerLevel: [2,3,4,5,6], effectPerLevel: 1 },
            armor:  { name: 'Броня',       icon: '🛡️', maxLevel: 5, costPerLevel: [2,3,4,5,6], effectPerLevel: 0.05 }
        },
        MAGIC: {
            cooldown:    { name: '-Кулдаун',    icon: '⏱️', maxLevel: 5, costPerLevel: [1,2,3,4,5], effectPerLevel: 0.05 },
            magicDamage: { name: '+Маг.урон',   icon: '✨', maxLevel: 5, costPerLevel: [2,3,4,5,6], effectPerLevel: 0.1 },
            duration:    { name: '+Длительн.',  icon: '⌛', maxLevel: 5, costPerLevel: [2,3,4,5,6], effectPerLevel: 0.1 }
        }
    },
