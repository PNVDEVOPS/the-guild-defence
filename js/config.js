...
const CONFIG = {
    ...
    ENEMIES: {
        ...
        GOBLIN_ELITE: {
            name: 'Элитный Гоблин', hp: 110, speed: 75, reward: 20, damage: 12,
        ...
        ORC_ELITE: {
            name: 'Элитный Орк', hp: 165, speed: 55, reward: 35, damage: 22,
        ...
        TROLL_ELITE: {
            name: 'Элитный Тролль', hp: 260, speed: 32, reward: 55, damage: 38,
        ...
        ZIGZAG_ELITE: {
            name: 'Элитный Уклонист', hp: 70, speed: 75, reward: 40, damage: 14,
